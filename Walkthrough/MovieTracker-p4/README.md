...
- This requires updating this method to be asynchronous, add the `using System.Threading.Tasks;` directive.
...
- Update the assertion code to handle a single movie and check all of its attributes.
