...
| Sql Example   | Link                                                   |
| ------------- | ------------------------------------------------------ |
| select.sql    | [select.sql](../Assets/SQL%20Example/select.sql)       |
| join.sql      | [join.sql](../Assets/SQL%20Example/join.sql)           |
| procedure.sql | [procedure.sql](../Assets/SQL%20Example/procedure.sql) |
| trigger.sql   | [trigger.sql](../Assets/SQL%20Example/trigger.sql)     |
| crud.sql      | [crud.sql](../Assets/SQL%20Example/net-salary.sql)     |
...
![][sql-join-1] ![][sql-join-2] ![][sql-join-3] ![][sql-join-4] ![][sql-join-5] ![][sql-join-6] ![][sql-join-7]
...
[sql-join-1]: images/sql-join-1.webp
[sql-join-2]: images/sql-join-2.webp
[sql-join-3]: images/sql-join-3.webp
[sql-join-4]: images/sql-join-4.webp
[sql-join-5]: images/sql-join-5.webp
[sql-join-6]: images/sql-join-6.webp
[sql-join-7]: images/sql-join-7.webp
[two-phase-lock]: images/two-phase-lock.webp
